...
public class MainView {
    ...
    public MainView() {
        ...
        // TODO
        KeyListener listener = new GameState.ActionListener();
    ...
    public void setScreen(Screen screen) {
        ...
        switch (screen) {
            ...
            case END_MENU_SCREEN:
                screenSize = StartMenuView.SCREEN_DIMENSIONS;
                break;
            case RUN_GAME_SCREEN:
                screenSize = RunGameView.SCREEN_DIMENSIONS;
                break;
            default:
